...
To be in the "Columns" mode, use the menu in the docheader to
switch modes.
...
across various content areas on the page, which are called  **columns**. For
example, "Border", "Middle: Left", "Middle: Center", etc.

Many icons are greyed out to make the interface look less cluttered.
Some icons don't display until you hover over specific areas.
...
#. Content element icon can provide a visual clue to the type of content
...
Highlighted areas will show where you can drop it.
